          ...
          <div className="space-y-6">
            ...
            <div className="glass-panel p-6 rounded-2xl relative overflow-hidden">
              ...
              {!project.generatedVideo ? (
                ...
                <div className="bg-green-500/10 border border-green-500/20 rounded-xl text-green-400 text-center text-sm font-medium py-3 px-4">Video generated successfully!</div>
              )}
            </div>
          </div>
        </div>
